...
function reportMarker() {
  ...
  document.getElementById("reportHeightA").innerHTML = hta;
  document.getElementById("reportHeightB").innerHTML = htb;
...
function elevationchart() {
  ...
  document.getElementById("reportTiltA").innerHTML = vertical_angle.toFixed(2);
  document.getElementById("reportTiltB").innerHTML = -vertical_angle.toFixed(2);
