...
function ctryChange() {
  ...
  var country_dict = {
    ...
    an: "60.178500, 19.915600, 36, 36, 36, 36",
    ...
    sm: "18.075277, -63.060001, 36, 36, 36, 36",
...
function populatefreq() {
  ...
  var groupChina = ["cn", "bd", "cu", "ir", "jm", "mo", "hn", "pk", "sy", "tz"];
  var groupETSI1 = [
    "af",
    "aw",
    "ai",
  ...
  } else if (groupChina.includes(ctry)) {
    if (s1.value == 10) {
      var arr = [5740, 5810];
    } else if (s1.value == 20) {
      var arr = [5745, 5805];
  ...
  } else if (groupSamoa.includes(ctry)) {
    if (s1.value == 10) {
      var arr = [5175, 5325, 5495, 5705, 5740, 5810];
    } else if (s1.value == 20) {
      var arr = [5180, 5320, 5500, 5700, 5745, 5805];
    } else if (s1.value == 40) {
      var arr = [5190, 5310, 5510, 5690, 5755, 5795];
    } else if (s1.value == 80) {
      var arr = [5210, 5290, 5530, 5670, 5775];
    }
